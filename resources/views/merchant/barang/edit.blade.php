...
<div class="container-fluid py-4">
    <div class="card">
        ...
        <div class="card-body px-4 pb-2">
            <form action="/merchant/barang/{{ $barang->id }}" method="POST">
                @method('put')
                @csrf
                    ...
                    <div class="col-md-6">
                        <div class="input-group input-group-static mb-4">
                            ...
                            <select class="form-control p-2" name="kategori" id="Kategori">
                                ...
                                @if (old('kategori') == "Makanan Berat" || $barang->kategori == 'Makanan Berat')
                                    <option value="Makanan Berat" selected>Makanan Berat</option>
                                @else
                                    <option value="Makanan Berat">Makanan Berat</option>
                                @endif

                                @if (old('kategori') == "Makanan Ringan" || $barang->kategori == 'Makanan Ringan')
                                    <option value="Makanan Ringan" selected>Makanan Ringan</option>
                                @else
                                    <option value="Makanan Ringan">Makanan Ringan</option>
                                @endif

                                @if (old('kategori') == "Minuman" || $barang->kategori == 'Minuman')
